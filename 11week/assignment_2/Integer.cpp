...
Integer::Integer(const std::string& str) {
     ...
     */
	Integer::value = parse_string(str);
}
...
Number *Integer::add(Number * num) {
    ...
    if (num->types() == INTEGER) {
		Integer* integer = new Integer(this->value + dynamic_cast<Integer*>(num)->val());
		delete num;
...
Number::type Integer::types() const {
     ...
     */
	return Number::type(INTEGER); // 구현한거 아님;;
}
